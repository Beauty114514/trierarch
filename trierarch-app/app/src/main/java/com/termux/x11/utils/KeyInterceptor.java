...
public class KeyInterceptor extends AccessibilityService {
    ...
    public static void launch(@NonNull Context ctx) {
        try {
            Settings.Secure.putString(ctx.getContentResolver(), Settings.Secure.ENABLED_ACCESSIBILITY_SERVICES, "app.trierarch/com.termux.x11.utils.KeyInterceptor");
            ...
            new AlertDialog.Builder(ctx)
                    ...
                    .setMessage("Android requires WRITE_SECURE_SETTINGS permission to start accessibility service automatically.\n" +
                            ...
                            "adb shell pm grant app.trierarch android.permission.WRITE_SECURE_SETTINGS")
                    .setNegativeButton("OK", null)
                    .create()
                    .show();

            if (MainActivity.getPrefs() != null)
                MainActivity.getPrefs().enableAccessibilityServiceAutomatically.put(false);
        }
    }
